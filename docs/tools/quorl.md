...
├  paritySamples · packages/money/tests/rounding-parity.ts:15:14
│  ├  15:67 · export const paritySamples: readonly Money[] = [money(1n, "USD"), money(99n, "USD")];
│  └  15:49 · export const paritySamples: readonly Money[] = [money(1n, "USD"), money(99n, "USD")];
...
│  ├  negate · 45:14
│  │  ├  45:48 · export const negate = (value: Money): Money => money(-value.minorUnits, value.currency);
│  │  ├  signedAmount · packages/accounts/src/posting.ts:25:14 · …
...
│  ├  add · 38:14
│  │  ├  42:10 · return money(left.minorUnits + right.minorUnits, left.currency);
│  │  ├  imbalance · packages/accounts/src/journal.ts:51:11 · …
...
│  │  │  └  31:33 · for (const posting of entry.postings) {
│  │  └  closedPeriodsBalance · packages/rules/src/builtin.ts:22:14 · …
│  │     ├  28:58 · (held, amount) => (held === undefined ? amount : add(held, amount)),
│  │     └  25:33 · .flatMap((entry) => entry.postings)
│  └  zero · 30:14
...
│  │  │  ├  postings · 44:13 · …
│  │  │  └  postings · 9:12 · …
│  │  └  postings · packages/importers/src/csv.ts:42:7 · …
│  └  amount · 9:63 · …
...
14 marked … were not expanded · raise depth or limit to follow them
~~~
