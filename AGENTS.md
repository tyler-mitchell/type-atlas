...
- After inspecting or experimentally proving a Volar.js affordance, update the locally retained `docs/volar-affordance-evidence.md`. Record the installed source, observed contract, TypeAtlas consequence, and validation status.
...
TypeAtlas MCP Usage:
- When a user says to use the "live", "actual", or "direct" MCP, they mean TypeAtlas attached to the current Codex session as first-class tools.
